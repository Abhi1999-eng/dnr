        ...
        {services.map((service) => {
          ...
          return (
            <Link
              ...
              href={href}
              className="glass group flex flex-col gap-3 rounded-[22px] border border-secondary/10 bg-[linear-gradient(180deg,#ffffff,rgba(247,249,251,0.97))] p-4 shadow-[0_18px_42px_rgba(15,23,42,0.08)] transition duration-300 hover:-translate-y-1.5 hover:border-primary/30 hover:shadow-[0_24px_54px_rgba(15,23,42,0.13)]"
            >
