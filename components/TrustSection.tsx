    ...
    <section className="container-wide mt-10 space-y-5">
      ...
      <ContentCarousel itemsPerView={{ mobile: 1, tablet: 2, desktop: 3, wide: 4 }}>
        {cards.map((p) => (
          <div
            key={p.title}
            className="h-full rounded-[22px] border border-secondary/10 bg-[linear-gradient(180deg,#ffffff,rgba(243,246,249,0.96))] p-4 shadow-[0_16px_36px_rgba(15,23,42,0.08)] transition hover:-translate-y-1 hover:shadow-[0_22px_44px_rgba(15,23,42,0.12)]"
          >
