      ...
      <ContentCarousel itemsPerView={{ mobile: 1, tablet: 2, desktop: 2, wide: 3 }}>
        {testimonials.map((t, index) => (
          <Reveal key={t.name} delay={index * 0.06} className="h-full">
            <div className="h-full rounded-[24px] border border-secondary/10 bg-[linear-gradient(180deg,#ffffff,rgba(248,250,252,0.96))] p-5 shadow-[0_18px_40px_rgba(15,23,42,0.08)] transition hover:-translate-y-1 hover:shadow-[0_24px_44px_rgba(15,23,42,0.12)]">
